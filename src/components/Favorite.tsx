...
const Favorite: React.FC = () => {
  ...
  const handleUnlike = async (productId: string) => {
    try {
      await api.delete(`/api/products/1/likes/${productId}`);
      // 찜 목록에서 해당 상품 제거
          ...
          {products.map((product) => {
            ...
            return (
              <div key={product.productID} style={{ position: 'relative' }}>
                <button
                  onClick={() => handleUnlike(product.productID)}
                  style={{
                    position: 'absolute',
                    top: '10px',
                    right: '10px',
                ...
                >
                  <AiFillHeart size={24} color="#dc2626" />
                </button>
                <div
                  style={{
                  ...
                  <div style={{ marginTop: '12px', marginBottom: '12px' }}>
                    ...
                    >
                      ...
                      <a
                        ...
                        onMouseOver={(e) => {
                          e.currentTarget.style.backgroundColor =
                            isPriceIncreased ? '#b91c1c' : '#1d4ed8';
                          e.currentTarget.style.transform = 'translateY(-1px)';
                        }}
                        onMouseOut={(e) => {
                          e.currentTarget.style.backgroundColor =
                            isPriceIncreased ? '#dc2626' : '#03318C';
